package br.com.joaotozzi.chordnotepadapi.utils;
...
public class TonalidadeUtils {

	private static HashMap<String, List<String>> tabelaDeTransposicao = new HashMap<String, List<String>>();

	public static String mudarTom(String conteudo, String tomOriginal, String tomAlvo) {
		String[] linhas = conteudo.split("\n");

		StringBuilder conteudoEmOutroTom = new StringBuilder();

		for (String linha : linhas) {
			conteudoEmOutroTom.append(mudarTomLinha(linha, tomOriginal, tomAlvo)).append("\n");
		}

		return conteudoEmOutroTom.toString();
	}

	private static String mudarTomLinha(String linha, String tomOriginal, String tomAlvo) {
		if (linha.endsWith(":")) {
			return linha;
		}
		...
		StringBuilder linhaEmOutroTom = new StringBuilder();

		for (String acorde : acordes) {
			if (acorde.isBlank()) {
				linhaEmOutroTom.append(acorde);
			} else if (acorde.trim().equals("|")) {
				linhaEmOutroTom.append(acorde).append(" ");
			} else {
				linhaEmOutroTom.append(mudarTomAcorde(acorde, tomOriginal, tomAlvo)).append(" ");
			}
		}

		return linhaEmOutroTom.toString();
	}

	private static String mudarTomAcorde(String acorde, String tomOriginal, String tomAlvo) {
		// inicializando tbl de conversão de tonalidade
		if (tabelaDeTransposicao.isEmpty()) {
			...
			// O correto é F#, mas '#' não funciona bem como parâmetro na URL
			tabelaDeTransposicao.put("Gb", new ArrayList<String>());
			tabelaDeTransposicao.get("Gb").add("_G");
			tabelaDeTransposicao.get("Gb").add("Gb");
			tabelaDeTransposicao.get("Gb").add("G");
			tabelaDeTransposicao.get("Gb").add("G#");
			tabelaDeTransposicao.get("Gb").add("_A");
			tabelaDeTransposicao.get("Gb").add("Ab");
			tabelaDeTransposicao.get("Gb").add("A");
			tabelaDeTransposicao.get("Gb").add("A#");
			tabelaDeTransposicao.get("Gb").add("_B");
			tabelaDeTransposicao.get("Gb").add("Bb");
			tabelaDeTransposicao.get("Gb").add("B");
			tabelaDeTransposicao.get("Gb").add("B#");
			tabelaDeTransposicao.get("Gb").add("Cb");
			tabelaDeTransposicao.get("Gb").add("C");
			tabelaDeTransposicao.get("Gb").add("C#");
			tabelaDeTransposicao.get("Gb").add("_D");
			tabelaDeTransposicao.get("Gb").add("_D#");
			tabelaDeTransposicao.get("Gb").add("Db");
			tabelaDeTransposicao.get("Gb").add("D");
			tabelaDeTransposicao.get("Gb").add("D#");
			tabelaDeTransposicao.get("Gb").add("_E");
			tabelaDeTransposicao.get("Gb").add("Eb");
			tabelaDeTransposicao.get("Gb").add("E");
			tabelaDeTransposicao.get("Gb").add("E#");
			tabelaDeTransposicao.get("Gb").add("Fb");
			tabelaDeTransposicao.get("Gb").add("F");
			tabelaDeTransposicao.get("Gb").add("F#");
		...
		List<String> notasAcordeOriginal = extrairNotas(acorde);
		...
		return substituirNotasDoAcorde(acorde, notasAcordeOriginal, notasAcordeAlvo);
	}
